...
``next_signal.core.models.get_model()`` is wrapped so all call paths (single agent
...
``next_signal/tools/browser.py``) are NOT limited — they need their own integration.
"""
