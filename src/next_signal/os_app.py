...
Run with::
    ...
    uv run uvicorn next_signal.os_app:app --port 7777 --reload
...
from next_signal.core.paths import ensure_dirs
from next_signal.orchestrator.runnable_loader import load_runnables
...
if __name__ == "__main__":
    ...
    uvicorn.run("next_signal.os_app:app", host="127.0.0.1", port=port, reload=True)
