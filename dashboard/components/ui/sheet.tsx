...
// Sheet uses the same Radix Dialog primitive as Dialog, but slides in
// from a side. Tokens come from the design's `.card` surface.
...
const sheetVariants = cva(
  "card fixed z-50 flex flex-col gap-4 p-6 shadow-pop transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
